...
public class Farmer { 
    ...
    @Column(name = "farm_type", nullable = false, length = 20)
    private String farmType; // Dairy, Crop, Poultry
    ...
    @Column(name = "animals_count", nullable = false)
	...
	public String toString() {
		return "Farmer [id=" + id + ", name=" + name + ", gender=" + gender + ", farmType=" + farmType + ", location="
				+ location + ", landSize=" + landSize + ", animalsCount=" + animalsCount + ", email=" + email
				+ ", contact=" + contact + "]";
	}
}
